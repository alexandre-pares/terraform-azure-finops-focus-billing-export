# FinOps FOCUS billing export for a Microsoft Customer Agreement (MCA)

This examples creates a FinOps FOCUS billing export scoped to a Microsoft Customer Agreement (MCA) billing account.

![FinOps FOCUS billing export for a Microsoft Customer Agreement (MCA)](../../assets/mca_export.png)

## Usage

First set the following variables:

- `var.mca_id` - Id of the Microsoft Customer Agreement (MCA). It can be found via the Azure Portal (portal.azure.com) via "Cost Management + Billing > Billing scopes > Select your MCA > Settings > Properties > Billing account id"
...
module "finops_focus_billing_export" {
  ...
  name           = substr("finops-focus-billing-export-for-mca-${var.mca_id}", 0, 64) # Don't need to replace ":" by "_" as MCA id is already too long and will be trucated
  description    = "FinOps FOCUS billing export for MCA ${var.mca_id}"
  export_version = "1.2-preview"
  scope_id       = "/providers/Microsoft.Billing/billingAccounts/${var.mca_id}"
...
![FinOps FOCUS billing export for a Microsoft Customer Agreement (MCA) - Directory](../../assets/mca_directory.png)
...
| ---- | ----------- | ---- | ------- | :------: |
| <a name="input_mca_id"></a> [mca\_id](#input\_mca\_id) | Id of the MCA billing account (used for the FinOps FOCUS billing export scope).<br/><br/>    Id can be found via the Azure Portal (portal.azure.com) via "Cost Management + Billing > Billing scopes > Select your MCA > Settings > Properties > Billing account id".<br/><br/>    Example:<br/><br/>    - `00000000-0000-5000-3000-000000000000:00000000-0000-4000-0000-000000000000_2019-05-31` | `string` | n/a | yes |
...
| Name | Description |
| ---- | ----------- |
| <a name="output_export_resource_id"></a> [export\_resource\_id](#output\_export\_resource\_id) | Id of the export.<br/><br/>  Example:<br/><br/>  - `/providers/Microsoft.Billing/billingAccounts/00000000-0000-5000-3000-000000000000:00000000-0000-4000-0000-000000000000_2019-05-31/providers/Microsoft.CostManagement/exports/finops-focus-billing-export-for-mca-00000000-0000-5000-3000-0000` |
