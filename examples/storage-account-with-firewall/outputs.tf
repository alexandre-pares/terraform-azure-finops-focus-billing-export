output "export_resource_id" {
  ...
  - `/subscriptions/00000000-0000-4000-0000-000000000000/providers/Microsoft.CostManagement/exports/finops-focus-billing-export-for-sub-00000000-0000-4000-0000-0000`

  DESCRIPTION

  value = null # module.finops_focus_billing_export.resource_id
}
...
output "months_backfilled" {
  ...
  value = null # module.finops_focus_billing_export.months_to_backfill
}
