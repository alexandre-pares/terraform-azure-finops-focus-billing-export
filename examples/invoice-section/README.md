# FinOps FOCUS billing export for an Invoice section

This examples creates a FinOps FOCUS billing export scoped to an Invoice section of a Billing profile of a Microsoft Customer Agreement (MCA) billing account.

![FinOps FOCUS billing export for an Invoice section](../../assets/invoice_section_export.png)

## Usage

First set the following variables:

- `var.mca_id` - Id of the Microsoft Customer Agreement (MCA). It can be found via the Azure Portal (portal.azure.com) via "Cost Management + Billing > Billing scopes > Select your MCA > Billing > Billing profiles > Select your Billing profile > Billing > Invoice sections > Select your Invoice section > Settings > Properties > Billing account > ID"
- `var.billing_profile_id` - Id of the billing profile. It can be found via the Azure Portal (portal.azure.com) via "Cost Management + Billing > Billing scopes > Select your MCA > Billing > Billing profiles > Select your Billing profile > Billing > Invoice sections > Select your Invoice section > Settings > Properties > Billing profile > ID"
- `var.invoice_section_id` - Id of the Invoice section. It can be found via the Azure Portal (portal.azure.com) via "Cost Management + Billing > Billing scopes > Select your MCA > Billing > Billing profiles > Select your Billing profile > Billing > Invoice sections > Select your Invoice section > Settings > Properties > Invoice section > ID"
...
module "finops_focus_billing_export" {
  ...
  scope_id       = "/providers/Microsoft.Billing/billingAccounts/${var.mca_id}/BillingProfiles/${var.billing_profile_id}/invoiceSections/${var.invoice_section_id}"

  storage_account_id = module.focus_billing_storage_account.resource_id
  container_name     = "focus"

  directory = "v1.2-preview/invoice_section_${var.invoice_section_id}"
...
![FinOps FOCUS billing export for an Invoice section - Directory](../../assets/invoice_section_directory.png)
...
| ---- | ----------- | ---- | ------- | :------: |
| <a name="input_billing_profile_id"></a> [billing\_profile\_id](#input\_billing\_profile\_id) | Id of the billing profile attached to `var.mca_id` (used for the FinOps FOCUS billing export scope).<br/><br/>    Id can be found via the Azure Portal (portal.azure.com) via "Cost Management + Billing > Billing scopes > Select your MCA > Billing > Billing profiles > Select your Billing profile > Billing > Invoice sections > Select your Invoice section > Settings > Properties > Billing profile > ID".<br/><br/>    Example:<br/><br/>    - `0000-0000-000-000` | `string` | n/a | yes |
| <a name="input_invoice_section_id"></a> [invoice\_section\_id](#input\_invoice\_section\_id) | Id of the invoice section attached to `var.billing_profile_id` (used for the FinOps FOCUS billing export scope).<br/><br/>    Id can be found via the Azure Portal (portal.azure.com) via "Cost Management + Billing > Billing scopes > Select your MCA > Billing > Billing profiles > Select your Billing profile > Billing > Invoice sections > Select your Invoice section > Settings > Properties > Invoice section > ID".<br/><br/>    Example:<br/><br/>    - `0000-0000-000-000` | `string` | n/a | yes |
| <a name="input_mca_id"></a> [mca\_id](#input\_mca\_id) | Id of the MCA billing account (used for the FinOps FOCUS billing export scope).<br/><br/>    Id can be found via the Azure Portal (portal.azure.com) via "Cost Management + Billing > Billing scopes > Select your MCA > Billing > Billing profiles > Select your Billing profile > Billing > Invoice sections > Select your Invoice section > Settings > Properties > Billing account > ID".<br/><br/>    Example:<br/><br/>    - `00000000-0000-5000-3000-000000000000:00000000-0000-4000-0000-000000000000_2019-05-31` | `string` | n/a | yes |
...
| Name | Description |
| ---- | ----------- |
| <a name="output_export_resource_id"></a> [export\_resource\_id](#output\_export\_resource\_id) | Id of the export.<br/><br/>  Example:<br/><br/>  - `/providers/Microsoft.Billing/billingAccounts/00000000-0000-5000-3000-000000000000:00000000-0000-4000-0000-000000000000_2019-05-31/BillingProfiles/0000-0000-000-000/invoiceSections/0000-0000-000-000/providers/Microsoft.CostManagement/exports/finops-focus-billing-export-for-invoice-section-0000-0000-000-00`<br/>  - `/providers/Microsoft.Billing/billingAccounts/00000000-0000-5000-3000-000000000000:00000000-0000-4000-0000-000000000000_2019-05-31/BillingProfiles/0000-0000-000-000/invoiceSections/0000-0000-000-000/providers/Microsoft.CostManagement/exports/finops-focus-billing-export-for-invoice-section-00000000-0000-40` |
